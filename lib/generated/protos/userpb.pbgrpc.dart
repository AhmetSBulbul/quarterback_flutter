...
class UserServiceClient extends $grpc.Client {
  ...
  static final _$updateUser = $grpc.ClientMethod<$3.UserUpdateRequest, $3.UserResponse>(
      ...
      ($core.List<$core.int> value) => $3.UserResponse.fromBuffer(value));
  static final _$uploadAvatar = $grpc.ClientMethod<$3.UpdateAvatarRequest, $3.UserResponse>(
      '/user.UserService/UploadAvatar',
      ($3.UpdateAvatarRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.UserResponse.fromBuffer(value));
  ...
  static final _$getFollowers = $grpc.ClientMethod<$1.GetByIdPaginatedRequest, $3.UserListResponse>(
      '/user.UserService/GetFollowers',
      ($1.GetByIdPaginatedRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.UserListResponse.fromBuffer(value));
  static final _$getFollowing = $grpc.ClientMethod<$1.GetByIdPaginatedRequest, $3.UserListResponse>(
      '/user.UserService/GetFollowing',
      ($1.GetByIdPaginatedRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.UserListResponse.fromBuffer(value));
  static final _$toggleBlock = $grpc.ClientMethod<$1.GetByIdRequest, $3.BlockResponse>(
      '/user.UserService/ToggleBlock',
      ($1.GetByIdRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.BlockResponse.fromBuffer(value));
  static final _$getBlocked = $grpc.ClientMethod<$1.GetByIdPaginatedRequest, $3.UserListResponse>(
  ...
  $grpc.ResponseFuture<$3.UserResponse> uploadAvatar($3.UpdateAvatarRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$3.UserListResponse> getFollowers($1.GetByIdPaginatedRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getFollowers, request, options: options);
  }

  $grpc.ResponseFuture<$3.UserListResponse> getFollowing($1.GetByIdPaginatedRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getFollowing, request, options: options);
  }

  $grpc.ResponseFuture<$3.BlockResponse> toggleBlock($1.GetByIdRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$toggleBlock, request, options: options);
  }

  $grpc.ResponseFuture<$3.UserListResponse> getBlocked($1.GetByIdPaginatedRequest request, {$grpc.CallOptions? options}) {
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$3.UserUpdateRequest, $3.UserResponse>(
        ...
        ($3.UserResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.UpdateAvatarRequest, $3.UserResponse>(
        'UploadAvatar',
        uploadAvatar_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $3.UpdateAvatarRequest.fromBuffer(value),
        ($3.UserResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$1.GetByIdPaginatedRequest, $3.UserListResponse>(
        'GetFollowers',
        getFollowers_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$1.GetByIdPaginatedRequest, $3.UserListResponse>(
        ...
        ($core.List<$core.int> value) => $1.GetByIdPaginatedRequest.fromBuffer(value),
        ($3.UserListResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.GetByIdRequest, $3.BlockResponse>(
        'ToggleBlock',
        toggleBlock_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.GetByIdRequest.fromBuffer(value),
        ($3.BlockResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.GetByIdPaginatedRequest, $3.UserListResponse>(
        'GetBlocked',
        getBlocked_Pre,
        false,
  ...
  $async.Future<$3.UserResponse> uploadAvatar_Pre($grpc.ServiceCall call, $async.Future<$3.UpdateAvatarRequest> request) async {
  ...
  $async.Future<$3.UserListResponse> getFollowers_Pre($grpc.ServiceCall call, $async.Future<$1.GetByIdPaginatedRequest> request) async {
    return getFollowers(call, await request);
  }

  $async.Future<$3.UserListResponse> getFollowing_Pre($grpc.ServiceCall call, $async.Future<$1.GetByIdPaginatedRequest> request) async {
    return getFollowing(call, await request);
  }

  $async.Future<$3.BlockResponse> toggleBlock_Pre($grpc.ServiceCall call, $async.Future<$1.GetByIdRequest> request) async {
    return toggleBlock(call, await request);
  }

  $async.Future<$3.UserListResponse> getBlocked_Pre($grpc.ServiceCall call, $async.Future<$1.GetByIdPaginatedRequest> request) async {
  ...
  $async.Future<$3.UserResponse> uploadAvatar($grpc.ServiceCall call, $3.UpdateAvatarRequest request);
  $async.Future<$3.FollowResponse> toggleFollow($grpc.ServiceCall call, $1.GetByIdRequest request);
  $async.Future<$3.UserListResponse> getFollowers($grpc.ServiceCall call, $1.GetByIdPaginatedRequest request);
  $async.Future<$3.UserListResponse> getFollowing($grpc.ServiceCall call, $1.GetByIdPaginatedRequest request);
  $async.Future<$3.BlockResponse> toggleBlock($grpc.ServiceCall call, $1.GetByIdRequest request);
  $async.Future<$3.UserListResponse> getBlocked($grpc.ServiceCall call, $1.GetByIdPaginatedRequest request);
